...
void loop()
{
  ...
  Serial.print(xaccel);  //print x value on serial monitor
  Serial.print(" m/sec^2\t");
  Serial.print("y accel:");
  Serial.print(yaccel);  //print y value on serial monitor
  Serial.print(" m/sec^2\t");
  Serial.print("z accel:");
  Serial.print(zaccel);  //print z value on serial monitor
  Serial.print(" m/sec^2\n");
  Serial.print("----------------------------------------------------------------------\n");
